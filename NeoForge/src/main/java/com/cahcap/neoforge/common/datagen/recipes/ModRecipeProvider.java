...
public class ModRecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    ...
    private void buildWorkbenchRecipes(RecipeOutput output, HolderLookup.Provider registries) {
        ...
        // Tools: Feather Quill, Cutting Knife | Input: Book | Materials: Flint*16, Lapis*5
        ...
        WorkbenchRecipeBuilder.builder()
                ...
                .input(Items.BOOK)
                .material(Items.FLINT, 16)
                .material(Items.LAPIS_LAZULI, 5)
                .result(efficiencyBook)
                .build(output, "efficiency_5_enchanted_book");
        
        // Smite V Enchanted Book
        // Tools: Feather Quill, Forge Hammer | Input: Book | Materials: Rotten Flesh*16, Bone*16, Lapis*5
        ...
        // Unbreaking III Enchanted Book
        // Tools: Feather Quill, Forge Hammer | Input: Book | Materials: Obsidian*8, Lapis*3
        ...
        WorkbenchRecipeBuilder.builder()
                ...
                .material(Items.LAPIS_LAZULI, 3)
                .result(unbreakingBook)
                .build(output, "unbreaking_3_enchanted_book");
        
        // Sharpness V Enchanted Book
        // Tools: Feather Quill, Cutting Knife | Input: Book | Materials: Quartz*16, Lapis*5
    ...
    private void buildCauldronRecipes(RecipeOutput output) {
        ...
        // Travel Potion (speed + jump boost)
        CauldronBrewingRecipeBuilder.builder()
