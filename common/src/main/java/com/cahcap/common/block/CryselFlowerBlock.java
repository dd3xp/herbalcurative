...
/**
 * Crysel flower block - grows on basalt or netherrack (stone-based Nether blocks)
 * Generates in Basalt Deltas and Nether Wastes biomes with crystallization particle effects
 */
public class CryselFlowerBlock extends HerbFlowerBlock {
    
    public CryselFlowerBlock(Holder<MobEffect> effect, float seconds, Properties properties) {
