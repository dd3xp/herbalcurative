...
/**
 * Pyraze flower block - grows on nylium or soul sand (dirt-based Nether blocks)
 * Generates in Warped Forest, Crimson Forest, and Soul Sand Valley biomes with flame particle effects
 */
public class PyrazeFlowerBlock extends HerbFlowerBlock {
    
    public PyrazeFlowerBlock(Holder<MobEffect> effect, float seconds, Properties properties) {
