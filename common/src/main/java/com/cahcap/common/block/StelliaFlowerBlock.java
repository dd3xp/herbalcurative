...
/**
 * Stellia flower block - only grows on End Stone
 * Generates in The End dimension with portal particle effects
 */
public class StelliaFlowerBlock extends HerbFlowerBlock {
    
    public StelliaFlowerBlock(Holder<MobEffect> effect, float seconds, Properties properties) {
        super(effect, seconds, properties);
    }
    
    @Override
    protected boolean mayPlaceOn(BlockState state, BlockGetter level, BlockPos pos) {
        // Only allow placement on End Stone or End Stone Bricks
