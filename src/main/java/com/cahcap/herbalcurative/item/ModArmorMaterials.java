...
public class ModArmorMaterials {
    ...
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = 
            DeferredRegister.create(Registries.ARMOR_MATERIAL, HerbalCurative.MODID);
    ...
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> WEAVELEAF = ARMOR_MATERIALS.register("weaveleaf",
            () -> new ArmorMaterial(
                    ...
                    List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(HerbalCurative.MODID, "weaveleaf"))),
                    0.5F, // toughness
