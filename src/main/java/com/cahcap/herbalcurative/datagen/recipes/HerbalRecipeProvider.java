package com.cahcap.herbalcurative.datagen.recipes;
 ...
 */
public class HerbalRecipeProvider extends RecipeProvider {
    
    public HerbalRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
