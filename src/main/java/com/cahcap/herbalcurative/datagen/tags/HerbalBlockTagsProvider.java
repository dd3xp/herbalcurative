 ...
 */
public class HerbalBlockTagsProvider extends BlockTagsProvider {
    
    public HerbalBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
