...
import com.cahcap.herbalcurative.block.ForestHeartwoodLeavesBlock;
import com.cahcap.herbalcurative.block.ForestHeartwoodSaplingBlock;
import com.cahcap.herbalcurative.block.HerbCabinetBlock;
import com.cahcap.herbalcurative.block.HerbCropBlock;
import com.cahcap.herbalcurative.block.HerbFlowerBlock;
...
public class ModBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(HerbalCurative.MODID);
    ...
    private static DeferredBlock<Block> registerCrystbudFlower(String name, int lightLevel) {
        DeferredBlock<Block> block = BLOCKS.register(name, () -> new com.cahcap.herbalcurative.block.CrystbudFlowerBlock(
                MobEffects.REGENERATION,
                5.0F,
                BlockBehaviour.Properties.of()
                        .mapColor(MapColor.PLANT)
    ...
    private static DeferredBlock<Block> registerPyrisageFlower(String name, int lightLevel) {
        DeferredBlock<Block> block = BLOCKS.register(name, () -> new com.cahcap.herbalcurative.block.PyrisageFlowerBlock(
                MobEffects.REGENERATION,
                5.0F,
                BlockBehaviour.Properties.of()
                        .mapColor(MapColor.PLANT)
    ...
    private static DeferredBlock<Block> registerRosyniaFlower(String name, int lightLevel) {
        DeferredBlock<Block> block = BLOCKS.register(name, () -> new com.cahcap.herbalcurative.block.RosyniaFlowerBlock(
                MobEffects.REGENERATION,
                5.0F,
                BlockBehaviour.Properties.of()
                        .mapColor(MapColor.PLANT)
