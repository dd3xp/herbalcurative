package com.cahcap.herbalcurative.client.layer;
...
public class HerbBoxPlayerLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(HerbalCurative.MODID, "textures/models/herb_box.png");
