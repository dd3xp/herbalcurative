...
public class ForestHeartwoodTreeFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        BlockState logState = ModRegistries.FOREST_HEARTWOOD_LOG.get().defaultBlockState()
        ...
        for (BlockPos leafPos : leafPositions) {
            ...
            BlockState leafState = ModRegistries.FOREST_HEARTWOOD_LEAVES.get().defaultBlockState()
        ...
        if (random.nextFloat() < 0.5f && !leafPositions.isEmpty()) {
            ...
            for (BlockPos leafPos : shuffled) {
                ...
                if ((berryPosState.isAir() || berryPosState.canBeReplaced()) &&
                    level.getBlockState(berryPos.above()).is(ModRegistries.FOREST_HEARTWOOD_LEAVES.get())) {
                    BlockState matureBerryState = ModRegistries.FOREST_BERRY_BUSH.get().defaultBlockState()
                        .setValue(ForestBerryBushBlock.AGE, Integer.valueOf(2));
